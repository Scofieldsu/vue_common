<template>
  <div class="hello">
    ...
    <!--<el-button @click="tokenClick">token test</el-button> -->
  </div>
</template>
  ...
  methods: {
    tokenClick () {
      this.axios.get('/api/resource', {
        ...
        // auth: {
        //   username: 'eyJhbGciOiJIUzI1NiIsImV4cCI6MTQ4ODMzMjc3NywiaWF0IjoxNDg4MzMyMTc3fQ.eyJpZCI6Mn0.CIE0Mr5-OK2zx7U0ukclLKqjt-Fq6Q6rsCWCHf3yf-g',
        //   password: ''
        // }
      })
      .then(function (res) {
